package com.zealot.recipe_project.bootstrap;

import com.zealot.recipe_project.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipies(){
        ...
        guacaRecipe.setDirections("1 Cut avocado, remove flesh: Cut the avocados in half. Remove seed. Score the inside " +
        ...
        guacaNotes.setRecipeNotes("For a very quick guacamole just take a 1/4 cup of salsa and mix it in with your " +
                "mashed avocados.\n" +
                "\n" +
                "Feel free to experiment! One classic Mexican guacamole has pomegranate seeds and chunks of peaches in " +
                "it (a Diana Kennedy favorite). Try guacamole with added pineapple, mango, or strawberries " +
                "(see our Strawberry Guacamole).");

        guacaRecipe.setNotes(guacaNotes);
        guacaNotes.setRecipe(guacaRecipe );

        guacaRecipe.addIngredient(new Ingredient("ripe avocados", new BigDecimal(2), eachUom, guacaRecipe));
        guacaRecipe.addIngredient(new Ingredient("Kosher salt", new BigDecimal(".5"), teaSpoonUom,guacaRecipe));
        guacaRecipe.addIngredient(new Ingredient("fresh lime juice or lemon juice", new BigDecimal(2),
                tableSpoonUom,guacaRecipe));
        guacaRecipe.addIngredient(new Ingredient("minced red onion or thinly sliced green onion",
                new BigDecimal(2), tableSpoonUom,guacaRecipe));
        guacaRecipe.addIngredient(new Ingredient("serrano chiles, stems and seeds removed, minced",
                new BigDecimal(2), eachUom,guacaRecipe));
        guacaRecipe.addIngredient(new Ingredient("Cilantro", new BigDecimal(2), tableSpoonUom,guacaRecipe));
        guacaRecipe.addIngredient(new Ingredient("freshly grated black pepper", new BigDecimal(2), dashUom,guacaRecipe));
        guacaRecipe.addIngredient(new Ingredient("ripe tomato, seeds and pulp removed, chopped",
                new BigDecimal(".5"), eachUom,guacaRecipe));
